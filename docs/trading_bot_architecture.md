#  Hyperliquid Trading Bot – Structure du projet

Ce document décrit la structure du projet pour le bot de trading modulaire sur **Hyperliquid**, avec intégration future de **l’IA** et de **plusieurs stratégies**.
...
│   │   ├── data.py                   # Récupération et prétraitement des données (candles, OHLCV) poue les stratégies
